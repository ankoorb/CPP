...
int main() {
    ...
    if (dict.find(key) == dict.end()){
        cout << "The key 'word' is not in the dict" << endl;
        cout << "Inserting a key-value pair into the dict" << endl;

        dict[key] = vector<string> {def_1, def_2, def_3, def_4};
    }
