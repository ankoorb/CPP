...
#ifndef INC_27_OVERLOADING_DEREFERENCE_OPERATOR_COMPLEX_H
#define INC_27_OVERLOADING_DEREFERENCE_OPERATOR_COMPLEX_H
...
namespace complex {
    ...
    public:
        ...
        // * operator (de-reference operator) overloading
        Complex operator*() const;  // Return type: New complex object
...
#endif //INC_27_OVERLOADING_DEREFERENCE_OPERATOR_COMPLEX_H
