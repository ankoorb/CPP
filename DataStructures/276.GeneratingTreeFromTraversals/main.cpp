...
//    cout << "preIndex: " << preIndex << ", " << flush;
//    cout << "inStart: " << inStart << ", " << flush;
//    cout << "inEnd: " << inEnd << ", " << flush;
//    cout << "inStart > inEnd: " << (inStart > inEnd) << ", " << flush;
...
//    cout << "node->data: " << node->data << " " << flush;
//
//    cout << "inStart == inEnd: " << (inStart == inEnd) << ", " << flush;
...
//    int inorder[] = {7, 6, 9, 3, 4, 5, 8, 2, 1};
    ...
    int preorder[] = {7, 1, 5, 8, 3, 6, 4};
    int inorder[] = {5, 1, 8, 7, 6, 3, 4};
